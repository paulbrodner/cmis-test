...
public class CmisRepository
{
    ...
    public void setBindingType(BindingType value)
    {
        ...
        {
            // atompub binding
            parameter.put(SessionParameter.ATOMPUB_URL, String.format(ATOMPUB_URL_FORMAT, getServerUrl()));
        ...
        {
            // browser binding
            parameter.put(SessionParameter.BROWSER_URL, String.format(BROWSER_URL_FORMAT, getServerUrl()));
            parameter.put(SessionParameter.BINDING_TYPE, BindingType.BROWSER.value());
            System.out.println("Accessing BROWSER_URL: " + parameter.get(SessionParameter.BROWSER_URL));
        }
    }
